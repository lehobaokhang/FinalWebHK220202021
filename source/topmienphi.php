    ...
    ?>
                ...
                <ul class="list-style-none d-flex justify-around align-center user-info">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="historyPayment.php">History payment</a></li>
        ...
        <main class="pb-4">
            <section class="book-genre-container mx-auto p-1">
                <h4 class="font-style-2 font-size-md color-2  border-bottom my-1 py-1 black-highlight pointer">8 Ứng
                    dụng/Trò chơi miễn phí tốt nhất</h4>
                <section class="book-cards-container d-flex flex-wrap justify-between">
                    <?php
                $conn = open_database();
                $sql = "select * from app_info where app_price = 0 order by app_rate desc limit ?, 8";
